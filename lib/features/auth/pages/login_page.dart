...
class _LoginPageState extends ConsumerState<LoginPage> {
  ...
  sendCodeToUser(String code) {
    if (phoneNumber.text.isEmpty) {
      AppExceptions.show('Please enter your phone number');
    } else if (phoneNumber.text.length < 8) {
      AppExceptions.show('Please enter a vaild phone number');
    } else {
      ref
          .read(authControllerProvider)
          .sendSms(context: context, phoneNumber: "$code${phoneNumber.text}");
    }
  }
            ...
            children: [
                ...
                child: MyTextField(
                  ...
                  prefixIcon: Container(
                    ...
                    child: MyOutlinedButton(
                      buttonStyle: ButtonStyle(side: MaterialStateProperty.all(BorderSide.none)),
                      onPressed: () {
                        showCountryPicker(
                            context: context,
                            showPhoneCode: true,
              ...
              Padding(
                ...
                child: MyOutlinedButton(
                    ...
                    onPressed: () {
                      sendCodeToUser("+${_country.phoneCode}");
                    },
                    child: MyText(
                      text: 'Send Code',
                      style:
