...
class _$_Task implements _Task {
  ...
  @override
  String toString() {
    return 'Task(id: $id, title: $title, description: $description, date: $date, isCompleted: $isCompleted, startTime: $startTime, endTime: $endTime, remind: $remind, repeat: $repeat)';
  }
